...
class DancingBlackWolf(QCAlgorithm):

    def Initialize(self):
        self.SetStartDate(2018, 4, 22)  # Set Start Date
    ...
    def OnData(self, data):
        ...
        #if not filled within one day, move limit price
    ...
    def OnOrderEvent(self, orderEvent):
        ...
        #send stop loss order if filled
